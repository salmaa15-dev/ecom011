...
} elseif ($_instance->childHasBeenRendered('oT8Ev2X')) {
    $componentId = $_instance->getRenderedChildComponentId('oT8Ev2X');
    $componentTag = $_instance->getRenderedChildComponentTagName('oT8Ev2X');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oT8Ev2X');
} else {
    $response = \Livewire\Livewire::mount('shop', ['productId' => $pack->id]);
    $html = $response->html();
    $_instance->logRenderedChild('oT8Ev2X', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        </div>
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aziz-ecom\resources\views\front-end\packs.blade.php ENDPATH**/ ?>