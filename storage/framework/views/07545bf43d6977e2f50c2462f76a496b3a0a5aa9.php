...
} elseif ($_instance->childHasBeenRendered('YpnBIIQ')) {
    $componentId = $_instance->getRenderedChildComponentId('YpnBIIQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('YpnBIIQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YpnBIIQ');
} else {
    $response = \Livewire\Livewire::mount('add-to-cart-button', ['productId' => $product->id]);
    $html = $response->html();
    $_instance->logRenderedChild('YpnBIIQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            <h4>Description</h4>
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aziz-ecom\resources\views\front-end\shop-products.blade.php ENDPATH**/ ?>