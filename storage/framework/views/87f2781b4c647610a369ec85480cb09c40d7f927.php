...
} elseif ($_instance->childHasBeenRendered('XOq4qqW')) {
    $componentId = $_instance->getRenderedChildComponentId('XOq4qqW');
    $componentTag = $_instance->getRenderedChildComponentTagName('XOq4qqW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XOq4qqW');
} else {
    $response = \Livewire\Livewire::mount('shop', ['productId' => $product->id]);
    $html = $response->html();
    $_instance->logRenderedChild('XOq4qqW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                       </div>
