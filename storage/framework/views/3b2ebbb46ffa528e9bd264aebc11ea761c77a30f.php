...
} elseif ($_instance->childHasBeenRendered('OYg9GM8')) {
    $componentId = $_instance->getRenderedChildComponentId('OYg9GM8');
    $componentTag = $_instance->getRenderedChildComponentTagName('OYg9GM8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OYg9GM8');
} else {
    $response = \Livewire\Livewire::mount('cart', []);
    $html = $response->html();
    $_instance->logRenderedChild('OYg9GM8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/front-end/checkout.blade.php ENDPATH**/ ?>