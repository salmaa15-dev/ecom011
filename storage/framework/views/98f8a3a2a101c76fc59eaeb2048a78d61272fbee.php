...
} elseif ($_instance->childHasBeenRendered('zwCditK')) {
    $componentId = $_instance->getRenderedChildComponentId('zwCditK');
    $componentTag = $_instance->getRenderedChildComponentTagName('zwCditK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zwCditK');
} else {
    $response = \Livewire\Livewire::mount('shop', ['productId' => $product->id]);
    $html = $response->html();
    $_instance->logRenderedChild('zwCditK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                       </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aziz-ecom\resources\views/front-end/home.blade.php ENDPATH**/ ?>