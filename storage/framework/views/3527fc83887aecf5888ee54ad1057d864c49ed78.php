...
} elseif ($_instance->childHasBeenRendered('TIxBfwk')) {
    $componentId = $_instance->getRenderedChildComponentId('TIxBfwk');
    $componentTag = $_instance->getRenderedChildComponentTagName('TIxBfwk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TIxBfwk');
} else {
    $response = \Livewire\Livewire::mount('shop', ['productId' => $product->id]);
    $html = $response->html();
    $_instance->logRenderedChild('TIxBfwk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    </div>
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/front-end/productByCategory.blade.php ENDPATH**/ ?>