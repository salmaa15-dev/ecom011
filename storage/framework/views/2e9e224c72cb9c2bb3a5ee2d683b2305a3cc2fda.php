...
} elseif ($_instance->childHasBeenRendered('hh7cfPN')) {
    $componentId = $_instance->getRenderedChildComponentId('hh7cfPN');
    $componentTag = $_instance->getRenderedChildComponentTagName('hh7cfPN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hh7cfPN');
} else {
    $response = \Livewire\Livewire::mount('cart-button', []);
    $html = $response->html();
    $_instance->logRenderedChild('hh7cfPN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </li>
...
</div><?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/front-end/partials/navbar.blade.php ENDPATH**/ ?>