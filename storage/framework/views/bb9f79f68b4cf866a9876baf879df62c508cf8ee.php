...
} elseif ($_instance->childHasBeenRendered('IIgFEKD')) {
    $componentId = $_instance->getRenderedChildComponentId('IIgFEKD');
    $componentTag = $_instance->getRenderedChildComponentTagName('IIgFEKD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IIgFEKD');
} else {
    $response = \Livewire\Livewire::mount('cart-button', []);
    $html = $response->html();
    $_instance->logRenderedChild('IIgFEKD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </li>
...
</div><?php /**PATH C:\xampp\htdocs\aziz-ecom\resources\views\front-end\partials\navbar.blade.php ENDPATH**/ ?>