...
<head>
    ...
    <meta property="og:image" content="@yield('image', $logo)">
    
    <link rel="stylesheet" href="{{ asset('front-end/assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front-end/assets/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front-end/assets/css/font.css') }}">
    <link rel="stylesheet" href="{{ asset('front-end/assets/css/swiper.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front-end/assets/css/style.css') }}">
    <link rel="shortcut icon" href="@yield('image', $logo)" type="image/x-icon">
    @yield('divider')
    @yield('loader-cart')
    @livewireStyles
</head>
...
@if(Request::is('login'))
    ...
    @elseif(count($categorysByPro) >= 0)
        <div class="pa-main-wrapper">
            ...
            <!-- copyright start -->
            @include('front-end.partials.copyright')
            <!-- copyright end -->
        </div>
        <!-- main wrapper end -->
        <script src="{{ asset('front-end/assets/js/jquery.min.js') }}"></script>
        <script src="{{ asset('front-end/assets/js/scroll.js') }}"></script>
        <script src="{{ asset('front-end/assets/js/bootstrap.min.js') }}"></script>
        <script src="{{ asset('front-end/assets/js/SmoothScroll.min.js') }}"></script>
